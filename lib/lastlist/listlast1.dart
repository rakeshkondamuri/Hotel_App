...
class Lastlist1 extends StatelessWidget {
  const Lastlist1({Key key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    String todo = "images/heritagevillage.jpg";
    return Scaffold(
